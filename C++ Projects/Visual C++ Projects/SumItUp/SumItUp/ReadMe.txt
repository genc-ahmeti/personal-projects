========================================================================
    KONSOLENANWENDUNG: SumItUp-Projektübersicht
========================================================================

Diese SumItUp-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre SumItUp-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "SumItUp.pch und eine 
